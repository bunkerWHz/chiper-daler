...
3. Dodge.
4. Climbing.
5. Heavy attack and parry.
6. Timed interaction states.
7. Items, throwing, ranged weapons, and magic as separate ability families.
8. Knockdown, rest, level-up, buffs, and debuffs as condition components.
